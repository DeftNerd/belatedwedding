                    ...
                    <div id="slider1" class="rev_slider">
                        <ul>
                            ...
                            <li data-transition="boxslide">
                                ...
                                <div class="banner-content-wrapper">
                                    ...
                                    style="font-size: 60px; color:#433e3e; line-height: 1.4; text-transform: uppercase; letter-spacing: 5px;  font-family: 'Roboto', sans-serif; font-weight: 500">
                                        <h1 class="head-text">Bethany <span>&amp;</span> Adam</h1>
                                    </div>
                            ...
                            <li data-transition="curtain-1">
                                <!-- MAIN IMAGE -->
                                <img src="assets/images/agency_banner.jpg"  alt="">
                                <!-- LAYERS -->
                                <div class="banner-content-wrapper">
                                    <!-- LAYER NR. 1 -->
                                    <div class="tp-caption NotGeneric-Title   tp-resizeme"
                                    id="slide-398-layer-7"
                                    data-x="center" data-hoffset=""
                                    data-y="center" data-voffset="60"
                                    data-width="['auto','auto','auto','auto']"
                                    data-height="['auto','auto','auto','auto']"
                                    ...
                                    style="font-size: 60px; color:#433e3e; line-height: 1.4; text-transform: uppercase; letter-spacing: 5px;  font-family: 'Roboto', sans-serif; font-weight: 500">
                                        <h1 class="head-text">Patricia <span>&amp;</span> Daniel</h1>
                                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="bell">
                                    <img src="/assets/images/aviator.png" alt="">
                                    <div class="inner-header-wrapper-left inner-header-wrapper">
                                        <h3><a href="https://bethanyduke.com">Bethany Duke</a></h3>
                                        <p>Bethany is a life-long learner and lover of all knowledge. She is degreed Art Historian and Archaeologist. She is an amazing artist, musician, and mother to three children.</p>
                                        <p>Her favorite things in life are coffee, the smell and content of a good book, the company of good people and friends, and her children.</p>
                                    </div>
                                </div>
                                <div class="jack">
                                    <img src="/assets/images/spaceman.png" alt="">
                                    <div class="inner-header-wrapper-right inner-header-wrapper">
                                        <h3><a href="https://deftnerd.com">Adam Brown</a></h3>
                                        <p>Adam is a computer geek who loves to learn new technologies to add to the things that he can build and to try to build the technologies of the future he hopes the world will have.</p>
                                        <p>His favorite things in life are finding cool media and knowledge for other people, creating software just for the fun of it, and making his children and Bethany smile.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="our-story">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <p>
                                    This is the start of out sweet little story, the part
                                    where your page meets mine, no matter where our tale takes us tomorrow,
                                ...
                                <div class="left-right-wrapper clearfix">
                                    ...
                                    <div class="left-section-content">
                                        <article class="met-section">
                                            <h3><a href="#">How We Met</a></h3>
                                            <div class="arrow-cls">
                                                <span class="css-shape">1996</span>
                                            </div>
                                            <p>Friends in High School</p>
                                            <a class="read-more" href="#">Read More <i class="fa fa-angle-right"></i></a>
                                        </article>
                                        <article class="met-section">
                                            <h3><a href="#">Moved in together</a></h3>
                                            <div class="arrow-cls">
                                                <span class="css-shape">Mar 2009</span>
                                            </div>
                                            <figure>
                                        ...
                                        <article class="met-section">
                                            <h3>Atticus joins our family</h3>
                                            <div class="arrow-cls">
                                                <span class="css-shape">Dec 2012</span>
                                            </div>
                                            <figure>
                                                <img src="/assets/images/atticus.jpg" alt="">
                                            </figure>
                                            <p>
                                                Ego vero volo in virtute vim esse quam maximam; Inde igitur, inquit, ordiendum est. Ne amores quidem sanctos a sapiente alienos esse arbitrantur. Non quam nostram quidem, inquit Pomponius iocans; De vacuitate doloris eadem sententia erit.
                                            </p>
                                            <a class="read-more" href="#">Read More <i class="fa fa-angle-right"></i></a>
                                        </article>
                                        <article class="met-section">
                                            <h3><a href="#">Year off in Puerto Rico</a></h3>
                                            <div class="arrow-cls">
                                                <span class="css-shape">Jul 2015</span>
                                            </div>
                                            <figure>
                                                <img src="/assets/images/puertorico.jpg" alt="">
                                            </figure>
                                            <p>Decided to take a year off in Puerto Rico</p>
                                            <a class="read-more" href="#">Read More <i class="fa fa-angle-right"></i></a>
                                        </article>
                                        <article class="met-section">
                                            ...
                                            <figure>
                                                <img src="assets/images/sm-img-1.png" alt="">
                                            </figure>
                                            <p>Ithaca NY</p>
                                            <a class="read-more" href="#">Read More <i class="fa fa-angle-right"></i></a>
                                        </article>
                                    ...
                                    <div class="right-section-content">
                                        <article class="met-section met-section-right">
                                            <h3><a href="#">Found each other again</a></h3>
                                            ...
                                            <p>Ran into eachother at a store and exchanged numbers. Started dating</p>
                                            <a class="read-more" href="#">Read More <i class="fa fa-angle-right"></i></a>
                                        </article>

                                        <article class="met-section met-section-right">
                                            <h3>Apollo joins our family</h3>
                                            <div class="arrow-cls right-arrow-cls">
                                                <span class="css-shape">Dec 2009</span>
                                            </div>
                                            <figure>
                                        ...
                                        <article class="met-section met-section-right">
                                            <h3>Athena completes the family</h3>
                                            <div class="arrow-cls right-arrow-cls">
                                                <span class="css-shape">Sept 2014</span>
                                            </div>
                                            <figure>
                                                <img src="/assets/images/athena.jpg" alt="" />
                                            </figure>
                                            <p>
                                                Ego vero volo in virtute vim esse quam maximam; Inde igitur, inquit, ordiendum est. Ne amores quidem sanctos a sapiente alienos esse arbitrantur. Non quam nostram quidem, inquit Pomponius iocans; De vacuitate doloris eadem sententia erit.
                                            </p>
                                        ...
                                        <article class="met-section met-section-right">
                                            <h3><a href="#">Finally getting married</a></h3>
                                            <div class="arrow-cls right-arrow-cls">
                                                <span class="css-shape">Jul 2016</span>
                                            </div>
                                            <p>
                                                Ego vero volo in virtute vim esse quam maximam; Inde igitur, inquit, ordiendum est. Ne amores quidem sanctos a sapiente alienos esse arbitrantur. Non quam nostram quidem, inquit Pomponius iocans; De vacuitate doloris eadem sententia erit.
                                            </p>
                            ...
                            <div class="col-xs-12 col-md-pull-1 col-md-5 col-sm-pull-2 col-sm-5">
                                <div class="event-description-wrapper">
                                    <div class="event-description">
                                        ...
                                        <a class="read-more" href="http://www.chapeldulcinea.org/directions/">Read More<i class="fa fa-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-md-5 col-sm-5 push">
                                <div class="event-description-wrapper reception-description-sec">
                                    <div class="event-description">
                                        ...
                                        <p>
                                            Maecenas eu placerat ante. Fusce ut neque justo,
                                            etauet enim. In hac habitasse platea dictumst.
                                            Nullam commodo neque erat, vitae facilisis erat.
                                        </p>
                                        <a class="read-more" href="event.html">Read More<i class="fa fa-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-7 col-sm-7 ">
                                    ...
                                    <div class="item">
                                        <div class="quoto">
                                            <div class="para-wrapper">
                                                <p>
                                                    “Congrats on finding your true love! Lean on each other’s strenghts and forgive each other weaknesses.
                                            ...
                                            <div class="overlay clearfix">
                                                <figure>
                                                    <img src="assets/images/profile-img-1.png" alt="">
                                                </figure>
                                                <span class="profile-info"> <strong>Andreah Willkinson</strong> <span>Best Friend</span> </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                                    ...
                                    <div class="item">
                                        <div class="quoto">
                                            ...
                                            <div class="overlay clearfix">
                                                ...
                                                <span class="profile-info"> <strong>Andrew</strong> <span>Best Friend</span> </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="quoto">
                                            ...
                                            <div class="overlay clearfix">
                                                ...
                                                <span class="profile-info"> <strong>Diana</strong> <span>Best Friend</span> </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="quoto">
                                            ...
                                            <div class="overlay clearfix">
                                                ...
                                                <span class="profile-info"> <strong>Immanuel</strong> <span>Best Friend</span> </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                ...
                <section class="wedding-gift">
                    <div class="container">
                        <div class="row text-center">
                            ...
                            <div class="sub-para">
                                <p>
                                    We're moving cross-country in the upcoming months and the less stuff we have the easier it'll be to move. Unless you have a closed trailer we can have to help us move, the best wedding gift we could hope to receive is money that we can use to outfit our new lives.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="wedding-section-gift">
                        <div class="container">
                            <div id="wedding-item">
                                ...
                                <div class="item">
                                    <div class="gift-class">
                                        <img src="/assets/images/gofundme.png" alt=""/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row text-center">
                            <div class="col-xs-12 col-sm-10 col-sm-push-1">
                                <div class="rsvp-wrapper" data-ng-controller="rsvp2Ctrl">
                                    <h3>RSVP</h3>
                                    <span class="plz-cls">Please RSVP before September 25</span>
